...
python3 -m accelerate.commands.launch \
    ...
    --model llava \
    --model_args pretrained="liuhaotian/llava-v1.6-vicuna-7b" \
    --tasks mmstar,mme,mmbench_en_dev,pope_pop,pope_aokvqa_pop,pope_gqa_pop,vqav2_val_lite \
    --batch_size 1 \
    --log_samples \
    ...
    --verbosity DEBUG \
    --square 1 \
    --wandb_args "project=llava1.6_recursive_eval_1126,entity=VLM_Hallucination_Woohyeon,name=thresh-30" \
...
python3 -m accelerate.commands.launch \
    ...
    --verbosity DEBUG \
    --square 1 \
    --wandb_args "project=llava1.6_recursive_eval_1126,entity=VLM_Hallucination_Woohyeon,name=thresh-15" \
...
python3 -m accelerate.commands.launch \
    ...
    --verbosity DEBUG \
    --square 1 \
    --wandb_args "project=llava1.6_recursive_eval_1126,entity=VLM_Hallucination_Woohyeon,name=thresh-35" \
