...
python3 -m accelerate.commands.launch \
    ...
    --save_output True \
    --output_csv_path "./generation_output_pope_84-168-336-672_topk03.csv" \
    --wandb_args "project=llava1.6_recursive_eval,entity=VLM_Hallucination_Woohyeon,name=Recursion_84-168-336-672_topk03"
