...
CUDA_VISIBLE_DEVICES=1 python3 -m accelerate.commands.launch \
    ...
    --save_output True \
    --output_json_path './logit_mistral_7b_pope_pop_1.0_bilinear_s1_top100.json' \
    --output_csv_path './generation_output_pope_pop_1.0_bilinear_s1_top100.csv' \
    --wandb_args 'project=llava1.6_recursive_eval_mistral-7b,entity=VLM_Hallucination_Woohyeon,name=pope_pop_1.0_bilinear_s1' \
