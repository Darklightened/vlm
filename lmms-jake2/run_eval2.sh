...
#     # --wandb_args "project=llava1.6_recursive_eval_Jake,entity=VLM_Hallucination_Woohyeon,name=woohyeon_ov_default"
...
python3 -m accelerate.commands.launch \
    ...
    --wandb_args "project=llava1.6_recursive_eval_Jake,entity=VLM_Hallucination_Woohyeon,name=llava-v1.6-7b-84-168-336-topk20"
