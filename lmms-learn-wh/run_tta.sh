...
python3 -m accelerate.commands.launch \
    ...
    --attention_threshold "[0.1,0.1,0.2]" \
    ...
    --tta_n_iter 100 \
    --wandb_args "project=llava1.6_recursive_eval_1209,entity=VLM_Hallucination_Woohyeon,name=tta-10-10-20-bilinear-relu-lr0.005-iter100" \
