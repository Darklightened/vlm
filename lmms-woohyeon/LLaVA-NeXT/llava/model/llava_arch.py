                    ...
                    if image_idx in video_idx_in_batch:  # video operations
                        ...
                        if "nobase" in mm_patch_merge_type:
                            ...
                            if generation_type == "downsampled":
                                ...
                                image_feature = torch.cat((downsampled_base_image_feature, base_image_feature), dim=0)
                            elif generation_type == "recursion_stage1":
                                ...
                                image_feature = torch.cat((downsampled_base_image_feature, base_image_feature, recursed_features), dim=0)
                            elif generation_type == "downsampled_tot":
                                image_feature = torch.cat((downsampled_base_image_feature, base_image_feature, image_feature), dim=0)
