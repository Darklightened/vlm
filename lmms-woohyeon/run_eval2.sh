...
python3 -m accelerate.commands.launch \
    ...
    --wandb_args "project=llava1.6_recursive_eval_woohye0n,entity=VLM_Hallucination_Woohyeon,name=llava-v1.6-7b-168-336-topk0.2"
    ...
    --verbosity DEBUG \
    --positional_embedding_type reduced \
    --wandb_args "project=llava1.6_recursive_eval_woohye0n,entity=VLM_Hallucination_Woohyeon,name=llava-v1.6-7b-168-336-topk0.4"
