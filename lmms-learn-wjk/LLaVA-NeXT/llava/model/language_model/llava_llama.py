...
class LlavaLlamaForCausalLM(LlamaForCausalLM, LlavaMetaForCausalLM):
    ...
    def __init__(self, config):
        ...
        self.model.image_mask_tensor = nn.Parameter(torch.ones(3060, 1, requires_grad=True))  
        ...
        #     "learnable_attn_threshold",
        #     nn.Parameter(torch.tensor([0.9, 0.9, 0.9], requires_grad=True))
        # )
    ...
    def init_threshold(self, threshold):
        self.learnable_attn_threshold = nn.Parameter(torch.tensor(threshold, requires_grad=True))
