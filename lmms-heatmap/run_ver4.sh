...
python3 -m accelerate.commands.launch \
    ...
    --verbosity DEBUG \
    --square 1 \
    --wandb_args "project=llava1.6_recursive_eval_1126,entity=VLM_Hallucination_Woohyeon,name=5stages-red-0.9-0.9-0.3" \
...
python3 -m accelerate.commands.launch \
    ...
    --verbosity DEBUG \
    --square 2 \
    --wandb_args "project=llava1.6_recursive_eval_1126,entity=VLM_Hallucination_Woohyeon,name=5stages-red2-1-1-0.3" \
    # --visualize_heatmap True \
    # --save_output True \
    # --output_csv_path "./generation_output_pope_84-168-336-672-pad-topk-80.csv" \
