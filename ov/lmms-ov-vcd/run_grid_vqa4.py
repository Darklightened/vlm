...
def generate_command(alpha, beta, gamma,  experiment_name_suffix):
    ...
    base_command = (
        ...
        f"--wandb_args 'project=llava1.6_recursive_eval_ov_0.5_cd,entity=VLM_Hallucination_Woohyeon,name=vqa_grid_exp1.0_attn_{experiment_name_suffix}'"
    )
    return base_command
...
def run_experiments():
    ...
    alphas = np.arange(0.2, 0.5, 0.1).tolist()
