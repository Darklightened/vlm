...
python3 -m accelerate.commands.launch \
    ...
    --tasks mmbench_en_dev_lite,mmmu_val,realworldqa,mme,pope_pop,mmstar,vqav2_val_lite \
    --batch_size 1 \
    --log_samples \
    ...
    --attention_threshold "[0.1, 0.1, 0.5]" \
    ...
    --verbosity DEBUG \
    --square 1 \
    --wandb_args "project=llava1.6_recursive_eval_1126,entity=VLM_Hallucination_Woohyeon,name=5stages-bil-recrelu-0.1-0.1-0.5" \
...
python3 -m accelerate.commands.launch \
    ...
    --positional_embedding_type bilinear_interpolation \
    --remove_unpadding True \
    --attn_norm norm_minmax \
    --stages "-2" "-1" "0" "1" \
    --verbosity DEBUG \
    --square 1 \
    --wandb_args "project=llava1.6_recursive_eval_1126,entity=VLM_Hallucination_Woohyeon,name=5stages-bil-recminmax-0.1-0.1-0.5" \
    # --visualize_heatmap True \
    # --save_output True \
    # --output_csv_path "./generation_output_pope_84-168-336-672-pad-topk-80.csv" \
