...
python3 -m accelerate.commands.launch \
    ...
    --verbosity DEBUG \
    --square 1 \
    --wandb_args "project=llava1.6_recursive_eval_search_1219_jake,entity=VLM_Hallucination_Woohyeon,name=topk-90-90-30-abn1%_drop" \
    # --save_output True \
    # --output_csv_path "./generation_output_pope_pop_tta-topk-90-90-30-bilinear-norm-lr0.01-iter100-n1.csv" \
