python3 -m accelerate.commands.launch \
    ...
    --verbosity DEBUG \
    --contrastive_alphas '0.5' '0.8' '0.9' \
    --wandb_args "project=llava1.6_recursive_eval_ov_0.5_cd,entity=VLM_Hallucination_Woohyeon,name=new_f16_0.5_bilinear_s1_[0.5-0.8-0.9]" \
    # --save_output True \
